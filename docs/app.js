...
// src/home/app.js
var initialize = () => {
  mount(document.body.appendChild(document.createElement("div")), (state) => node("div", [
    node("h1", "Apps"),
    node("ul", state.apps.filter((app) => app.published || false).map((app) => node("li", node("a", {
      href: app.path + "/"
    }, app.title))))
  ]), {
    apps: [{
...
//# debugId=CA6583AE83E7389A64756E2164756E21
